                    ...
                    <div className="container mx-auto">
                        ...
                        >
                            ...
                            >
                                ...
                                <p className="text-base text-gray-600 mb-12">
                                    cities and towns with active Rentify listings
                                </p>
                                <p className="text-sm text-gray-400">
                            ...
                            >
                                ...
                                <p className="text-base text-gray-600 mb-12">
                                    countries and regions with Rentify listings
                                </p>
                                <p className="text-sm text-gray-400">
                                    as of March 31, 2023
                                </p>
                            ...
                            >
                                ...
                                <p className="text-base text-gray-600 mb-12">
                                    Rentify guest arrivals all-time
                                </p>
                                <p className="text-sm text-gray-400">
                                    as of September 31, 2023
                                </p>
                        ...
                        <div className="easy-search-wrapper flex gap-10">
                            <div className="easy-text w-2/3">
                                <p className="text-base text-gray-600 mb-5">
                                    ...
                                    using our site. Rentify is the easiest way
